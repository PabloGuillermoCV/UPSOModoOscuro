...
/**
 * Este archivo declara las variables de configuración necesarias para el funcionamiento del plugin
 */
...
//El nombre del theme, no debería ser necesario modificar esto                                                                                             
$THEME->name = 'upsodarkmode';                                                                                                             
...
// extensions.
/**
 * Aquí se declaran los archivos CSS/SCSS que el plugin debe tomar 
 * en este caso, le decimos al plugin que use el archivo de estilos "moodle.css" 
 * notar que el ".css" NO VA en este archivo de configuración
 * los archivos de este tipo DEBEN estar en la carpeta "style"  
 * */                                                                                                                      
$THEME->sheets = [
    'moodle'
];                                                                                                                
...
//Aquí irian los nombres de los archivos CSS/SCSS para el editor de texto de Moodle                                                                
$THEME->editor_sheets = [];                                                                                                         
...
//Aquí se declaran los theme Padre de nuestro plugin, como nosotros dependemos de Boost, lo declaramos aquí                                                                       
$THEME->parents = ['boost'];                                                                                                        
 
//No sería necesario modificar nada de acá abajo
...
$THEME->scss = function($theme) {                                                                                                   
    return theme_upsodarkmode_get_main_scss_content($theme);                                                                               
};
